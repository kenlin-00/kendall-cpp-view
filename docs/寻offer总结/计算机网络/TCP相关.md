...
- [什么是TCP粘包/拆包，发生的原因](#什么是tcp粘包拆包发生的原因)
  - [粘包和拆包原因](#粘包和拆包原因)
  - [粘包和拆包解决策略](#粘包和拆包解决策略)
- [MTU 和 MSS](#mtu-和-mss)
- [TCP 三次握手](#tcp-三次握手)
...
- **快速恢复**: 
  ...
  - 如果收到新数据的 ACK 后，把 cwnd 设置为第一步中的 ssthresh 的值，原因是该 ACK 确认了新的数据，然后再次进入拥塞避免状态；

![](https://cdn.jsdelivr.net/gh/kendall-cpp/blogPic@main/寻offer总结02/快速重传03.45n6fg3adfc0.png)
